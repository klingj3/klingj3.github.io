  ...
  <Section id="contact">
    <ContentWrap>
      ...
      <EntryContent initial="hidden" whileInView="visible" viewport={sectionViewport} variants={fadeUp}>
        ...
        <RefList>
          <RefLink href="https://github.com/klingj3" target="_blank" rel="noopener noreferrer">
          ...
          <RefLink href="https://linkedin.com/in/john-klingelhofer-349892a5" target="_blank" rel="noopener noreferrer">
